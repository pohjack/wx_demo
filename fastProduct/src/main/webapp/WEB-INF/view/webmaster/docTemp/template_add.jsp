	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-fixed">
					...
					<div class="main-fieldset">
						<div class="preview">
						    <fieldset>
						      ...
						      <div class="text" id="prev">${preview }</div>
						    </fieldset>
					    </div>
						<div class="edit">
						    <fieldset class="left">
						    ...
						    <fieldset class="right" style="width:38%">
						      ...
						      <div class="text">
                                ...
                                <div class="variable">
                                	<table width="100%"  id="sysVars" 
                                	class="hover cell-border" style="table-layout: fixed;">
                                		<thead>
	                                		<tr>
	                                			<td width="15%">序号</td>
	                                			<td width="40%">名称</td>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				editor.create();
				 document.onkeydown = function(e){//TODO 手动输入的内容存在于标签内部
					 ...
					 }else */ if(oEvent.ctrlKey && (oEvent.keyCode == 90 || oEvent.keyCode == 89)){ //禁用Ctrl+Z 和 Ctrl + Y TODO
						 	oEvent.preventDefault();  
						 	window.event.returnValue = false; 
					 }
					
				}
				 function removeTemp(tag){
					 $.ajax({    
				         url : "${pageContext.request.contextPath}/template/removeBaseTemp",                               
				         data : {
				        	 "id" : $(tag).attr("tempId")
				         },   
				         type : 'post',    
				...
				$("#sysVars tbody").on("click","tr",function(){
					...
					var color = " ";
					var attr = "contenteditable='false'";
					if(1 == cat){
						color = "red";
					}else if(2 == cat){
						color = "green";
					...
					/* $.ajax({    
				         url : "${pageContext.request.contextPath}/template/addToBase",                               
				         data : {
				         ...
				         success : function(data) {   
				        	 if(data.result){ */
				        	 var contain = range.commonAncestorContainer.nodeName;
				        	 var span = document.createElement("span");
				        	 span.style.color=color;
				        	 span.contentEditable="false";
				        	 span.innerHTML=datas.value;
			...
			function updateToDocs(){
				$.ajax({    
			         url : "${pageContext.request.contextPath}/template/updateToDocs",                               
			         data : {
			        	 "id" : $("#masterId").val(),
			        	 "quoteId" : data.id,//TODO
			        	 "value" : data.value,
			        	 "category" : cat
			         },   
			         type : 'post',    
			...
			function rebuildPreview(){
				$.ajax({    
			         url : "${pageContext.request.contextPath}/template/rebuildPrev",                               
			         data : {
