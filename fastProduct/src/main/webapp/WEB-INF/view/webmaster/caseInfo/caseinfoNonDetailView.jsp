...
<body
						...
						<div class="tabbable-line boxless tabbable-reversed">
							<ul class="nav nav-tabs" id="navbar">
								...
								<li class=""><a href="#tab_3" data-toggle="tab"
									aria-expanded="false"
									onclick="skip('${pageContext.request.contextPath}/webmaster/caseInfo/toDenceView')">
										涉案证据 </a></li>
							...
							<div class="inspect print">
								...
								<table id="table">
									<tr class="tablehead">
										<td style="width: 13mm; font-family: 宋体; font-size: 4.518mm;">序号</td>
										<td style="width: 58mm; font-family: 宋体; font-size: 4.518mm;">品牌</td>
										<td style="width: 50mm; font-family: 宋体; font-size: 4.518mm;">条盒打码1</td>
										<td style="width: 50mm; font-family: 宋体; font-size: 4.518mm;">条盒打码2</td>
										<td
											style="height: 8.6688mm; width: 16mm; font-family: 宋体; font-size: 4.518mm;">数量<br>(条)
										</td>
									</tr>
									<tbody>
										...
										<c:forEach items="${nons }" var="non" varStatus="status">
											<tr class="datas">
												<td
													style="font-family: 宋体; font-size: 4.518mm; border-left: 1px solid #000;"><span
												...
												<td
													style="height: 13.7524mm; font-family: 宋体; font-size: 4.518mm;"
													class="edit"><span data-name='code1'>${non.code1}</span></td>
												<td style="font-family: 宋体; font-size: 4.518mm;"
													class="edit"><span data-name='code2'>${non.code2}</span></td>
												<td style="font-family: 宋体; font-size: 4.518mm;"
													class="edit"><span data-name='number'>${non.number}</span></td>
	...
	<script type="text/javascript">
		...
		var nonjson = '${nonjson}';
		var nons = eval('(' + nonjson + ')');
		for ( var p in nons) {//遍历json对象的每个key/value对,p为key
			var non = nons[p];
			for (var i = 0; i < non.length; i++) {
				var n = non[i];
				/* 
				 $("#table").find("tr:eq(" + (i + 1) + ")").find("td:eq(0)")
				 .html(" +n.name +"'  />"); */
