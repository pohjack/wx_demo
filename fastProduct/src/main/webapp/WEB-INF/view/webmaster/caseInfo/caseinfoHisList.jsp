...
<html>
	...
	<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-fixed">
		...
		<script>"src/main/java/com/frame/tobaCase/controller"
			App.setAssetsPath("");
        		...
        		table = $("#caseInfoList").DataTable({
        			...
        			"sAjaxSource": "${pageContext.request.contextPath}/webmaster/caseInfo/getPagingList?t="+Math.random(),      //这个是请求的地址    
                     ...
                     "fnServerData" : function(sSource, aoData, fnCallback) {
                    	...
                    	var idCard = $("#idCard").val();
                    	var premises = $("#premises").val();
                    	var searchDate = '{removeStatue:0, caseStatus:0, perRespon:"' +perRespon +'",regiNo:"' +regiNo +'",idCard:"' +idCard +'",premises:"' +premises +'",startDate:"' +startDate +'",endDate:"' +endDate +'"}'; */
                    	var searchDate = tableSearch();//获取查询条件的json数据，可以传入特定的id数组获得特定查询条件
                    	searchDate["removeStatue"] = 0;
                    	searchDate["caseStatus"] = 0;
         			...
         			"fnRowCallback" : function(nRow, aData, iDisplayIndex) {// 当创建了行，但还未绘制到屏幕上的时候调用，通常用于改变行的class风格 		
						var secondTDHtml = iDisplayIndex+1;
	                  	...
	                  	var optHtml= "<div class='margin-bottom-5'><shiro:hasPermission name='case:edit'><a class='btn  btn-sm blue btn-outline filter-submit margin-bottom' href=\"${pageContext.request.contextPath}/webmaster/caseInfo/toHisView?tagId=2&caseInfoId="+aData.id+"\">登记查看</a></shiro:hasPermission>" ;
	                  	optHtml += "<a class='btn btn-sm green btn-outline' href='${pageContext.request.contextPath}/docTemplate/toInspect?caseId=" +aData.id +"'>文书预览</a></div>" ;
