							...
							<div class="tabbable-line boxless tabbable-reversed">
										<div class="portlet box green-turquoise">
											<div class="portlet-title">
												<div class="caption">
													<i class="fa fa-plus-square"></i><c:if test="${not empty obj.id}" >编辑</c:if><c:if test="${empty obj.id}" >新建</c:if>卷烟信息
												</div>
											</div>
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																...
																<div class="col-md-8">
																	<input type="text" name="name" id="name" value="${obj.name }" maxlength="100" class="form-control">
																</div>
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																...
																<div class="col-md-8">
																	<input type="text" name="retailPrice" id="retailPrice" value="${obj.retailPrice }" maxlength="6" class="form-control">
																</div>
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																...
																<div class="col-md-8">
																	<input type="text" name="barCode" id="barCode" value="${obj.barCode }" maxlength="32" class="form-control">
																</div>
															</div>
														</div>
													</div>
			...
			if(submitClick){
				$.ajax({
					...
					success : function(data) {
						...
						window.location.href="${pageContext.request.contextPath}/webmaster/cigarInfo/toList";
					}
				});
			}
		});
