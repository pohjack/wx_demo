			...
			<form id="myForm">
				<table class="table table-bordered" style="width:70%">
					...
					<tbody>
						...
						<tr>
							<td>编号</td>
							<td><input type="text" name="orgCode" id="orgCode" class="form-control"/></td>
						</tr>
						<tr>
							<td>名称</td>
							<td><input type="text" name="orgName" id="orgName" class="form-control"/></td>
						</tr>
						<tr>
							<td>地址</td>
							<td><input type="text" name="orgAddress" class="form-control"/></td>
						</tr>
						<tr>
							<td>上级</td>
							<td>
									<c:if test="${not empty name }">
										<input type="hidden" name="orgPid" class="form-control" value="${id }" />
						...
						<tr>
							...
							<td style="line-height:1.43"><textarea rows="2" cols="50" name="orgDescription" class="form-control"></textarea>
						</tr>
						<tr>
